...
const projects = [
  {
    title: "Senai-ID",
    description:
      "Carteirinha digital para estudantes e funcionários do SENAI com sistema de autenticação e gestão de perfis.",
    category: "Full Stack",
  ...
  },
  {
    ...
    description:
      "Portal dedicado aos maiores ícones do esporte brasileiro, com design responsivo e foco em acessibilidade.",
    category: "Frontend",
  ...
  },
  {
    ...
    description:
      "Plataforma para gestão de processos e ocorrências policiais com interface intuitiva para registro e consulta.",
    category: "Full Stack",
        ...
        {projects.map((project) => (
          <div key={project.title} className="flex flex-col h-full">
            ...
            >
              ...
              <div className="mb-4 overflow-hidden rounded-lg border border-white/10 bg-[#121412]">
              ...
              <div className="flex gap-2 mt-auto pt-4 border-t border-gray-800/50">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 rounded-lg bg-gray-900/50 px-4 py-3 text-base font-medium text-gray-300 transition-all hover:bg-gray-800 hover:text-white group/btn"
                >
                  <Github size={16} />
                  <span>Código</span>
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 rounded-lg border border-gray-700 bg-gradient-to-r from-gray-800 to-gray-900 px-4 py-3 text-base font-medium text-white transition-all hover:from-gray-700 hover:to-gray-800 group/btn"
                >
                  <ExternalLink size={16} />
                  <span>Demo</span>
                  <ArrowRight
                    size={14}
                    className="opacity-0 group-hover/btn:opacity-100 group-hover/btn:translate-x-0.5 transition-all"
                  />
                </a>
              </div>
            </Card>
        ...
        <div className="inline-flex flex-col items-center gap-6 max-w-2xl mx-auto p-8 rounded-2xl bg-gradient-to-br from-gray-900/50 to-gray-950/50 border border-gray-800">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-400 text-lg">
              Explore meu GitHub para ver todos os projetos, contribuições e
              experimentos.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              icon={<Github size={20} />}
              onClick={() =>
                window.open("https://github.com/igor-teixeira-souza", "_blank")
              }
            >
              GitHub Completo
            </Button>
