...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-4 md:p-6 flex justify-between items-center text-white bg-black/90 backdrop-blur-md border-b border-gray-800">
      {/* Logo/Nome */}
